...
public class Eliptical : GalaxyType
{
    public Eliptical(List<Star> inStars, GalaxyRandom inRandom, int inNumberOfStars, Vector3 inGalaxyRadius, Texture2D inStarColour)
    {
        mRandom = inRandom;
