...
public static class GenerateStarName
{
    private static readonly string[] RealStarNames =
{
    ...
    private static readonly MarvellousMarkovModels.Model MarkovNameModel =
        new ModelBuilder(3)
            .Teach(RealStarNames)
    ...
    // Naming Strategies
    private static string PlainMarkov(System.Random random)
    {
    ...
    private static string NamedStar(System.Random random)
    {
        return random.RandomChoice(Names) + "'s Star";
    }

    // Prefix and Suffix Strategies
    private static string Greek(System.Random random)
    {
        return random.RandomChoice(GreekLetters);
    }

    private static string Decorator(System.Random random)
    {
        return random.RandomChoice(Decorators);
    }

    private static string RomanNumeral(System.Random random)
    {
    ...
    private static string Letter(System.Random random)
    {
        var letter = (char)random.Next(65, 90);
        return letter.ToString();
    }

    private static string Integer(System.Random random)
    {
        var number = (int)random.NormallyDistributedSingle(100, 5, 1, 1000); ;
        return number.ToString();
    }

    private static string Decimal(System.Random random)
    {
    ...
    // Modifiers
    private static Func<System.Random, string> WithDecoration(float probability, Func<System.Random, string> func)
    {
        return (r) =>
        {
            var result = func(r);
    ...
    private static bool RandomChoice(this System.Random random, float bias = 0.5f)
    {
        return random.NextDouble() < bias;
    }

    private static Tuple<float, Func<System.Random, string>> Weighted(float f, Func<System.Random, string> s)
    {
        return Tuple.Create(f, s);
    }

    private static T RandomChoice<T>(this System.Random random, IEnumerable<T> choices)
    {
    ...
    private static T WeightedChoice<T>(this System.Random random, List<Tuple<float, T>> choices)
    {
    ...
    public static string Generate(System.Random random)
    {
        return random.WeightedChoice(_namingStrategies)(random);
    }

    public static IEnumerable<string> Generate(System.Random random, int count)
    {
